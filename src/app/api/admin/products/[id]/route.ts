...
export async function PUT(
  ...
  if (body.how_to_use !== undefined) data.how_to_use = body.how_to_use ?? null;
  if (body.ingredients !== undefined)
    data.ingredients = body.ingredients ?? null;
  if (body.form !== undefined)
    data.form =
      cosmetic_form[body.form as keyof typeof cosmetic_form] ?? undefined;
  if (body.target_skin !== undefined)
    data.target_skin =
      skin_type[body.target_skin as keyof typeof skin_type] ?? undefined;
